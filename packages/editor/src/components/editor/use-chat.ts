...
import { aiChatPlugin } from '@memory-prosthetic/editor/components/editor/plugins/ai-kit'
...
const createCommentChunks = (editor: PlateEditor) => {
  ...
  const resultChunks = [[{ delay: 50, texts: '{"data":"comment","type":"data-toolName"}' }], ...chunks]
