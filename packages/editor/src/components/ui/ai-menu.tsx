...
import { Command, CommandGroup, CommandItem, CommandList } from '@memory-prosthetic/ui/components/ui/command'
...
export function AIMenu() {
  ...
  }, [streaming, editor.api.toDOMNode, api.aiChat.node])
  ...
  React.useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isLoading, editor.api.toDOMNode, editor.api.block, mode, toolName, editor.api.node, editor.getApi])
