            ...
            {Array.from({ length: DAYS_IN_WEEK }, (_, dayIndex) => (
              <tr className="h-2.5" key={DAYS[dayIndex]}>
                ...
                <td className="relative w-7 min-w-7 text-foreground">
                  {dayIndex % 2 === 0 && <span className="-bottom-0.5 absolute left-0 text-xs">{DAYS[dayIndex]}</span>}
                </td>
                ...
                {Array.from({ length: WEEKS_IN_YEAR }, (_, w) => {
                  ...
                  return (
                    ...
                    <td
                      ...
                      title={
                        showTooltips ? `${formatDate(dayData.date)}: ${getContributionText(dayData.count)}` : undefined
                      }
                    >
                      <div
