...
const Notification = () => (
  <div className="flex w-64 items-center gap-3 overflow-hidden px-4 py-2 text-foreground">
    ...
    <div className="flex-1">
      ...
      <p className="pointer-events-none text-white text-xs opacity-70">You have a new notification!</p>
    </div>
  ...
  return (
    <div className="flex w-72 items-center gap-3 overflow-hidden px-4 py-2 text-foreground">
      ...
      <div className="min-w-0 flex-1">
        <p className="pointer-events-none truncate font-medium text-sm text-white">Lofi Chill Beats</p>
