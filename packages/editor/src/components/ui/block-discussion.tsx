...
import { commentPlugin } from '@memory-prosthetic/editor/components/editor/plugins/comment-kit'
import { discussionPlugin, type TDiscussion } from '@memory-prosthetic/editor/components/editor/plugins/discussion-kit'
import { suggestionPlugin } from '@memory-prosthetic/editor/components/editor/plugins/suggestion-kit'
import { Button } from '@memory-prosthetic/ui/components/ui/button'
import { Popover, PopoverAnchor, PopoverContent, PopoverTrigger } from '@memory-prosthetic/ui/components/ui/popover'
...
const BlockCommentContent = ({
  ...
  const open = Open || selected || (isCommenting && !!draftCommentNode && commentingCurrent)
  ...
  }, [activeSuggestion, activeCommentId, editor.api, suggestionNodes, draftCommentNode, commentNodes, editor.getApi])
